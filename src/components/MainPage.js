    ...
    <Timeline position="alternate">
      ...
      <TimelineItem>
        <TimelineOppositeContent
          ...
          color="text.secondary"
        >
          Jakoś od marca do kwietnia/maja...
        </TimelineOppositeContent>
        <TimelineSeparator>
          <TimelineConnector />
          <TimelineDot color="primary" variant="outlined">
        ...
        <Grid item xs={6}>
          <Box sx={{ marginTop: 2, marginBottom: 2 }}>
            ...
            <Typography sx={{ paddingBottom: 2}}>
              Poniżej możesz przeczytać, jak to przedsięwzięcie będzie przebiegało. Brzmi interesująco? Jeśli tak, to zapraszam na mój kanał na Twitchu: <Link href="https://www.twitch.tv/pisarski_kociol">Pisarski Kocioł</Link>. Zaczynamy we wtorek <strong>1,03,2022</strong>.
            </Typography>
          </Box>
        </Grid>
        <Grid item xs={6}>
